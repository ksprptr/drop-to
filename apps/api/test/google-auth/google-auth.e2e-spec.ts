...
/**
 * Guards the OAuth consent flow: initiation is operator-only and the callback is bound to a
 * cookie-stored `state` nonce, so an unauthenticated party cannot bind/swap the Drive account.
 */
